...
sleep 2
git clone https://github.com/leepteste/leepteste2.0/SINTEX
git clone https://github.com/leepteste/leepteste2.0/apikey
git clone https://github.com/leepteste/leepteste2.0/testek
cd leepteste2.0
chmod +x git.sh
echo "$verde"
